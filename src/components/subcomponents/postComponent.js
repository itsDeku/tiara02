	...
	return (
		<div id='first' className="posts-component">
			<div className="posts-top">
				...
				<div className="posts-users-name"><span>{props.username}</span></div>
			...
			<div className="posts-img">
				<img src="pop_the_forgotten_sands-wallpaper-1920x1080.jpg" alt="sd" style={{ width: 100 + '%', height: 216 + 'px' }}></img>
			</div>
